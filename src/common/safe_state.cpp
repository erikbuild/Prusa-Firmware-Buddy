...
void hwio_safe_state(void) {
    ...
    dwarf6Reset.reset();
    #else
    static_cast<CFanCtl3Wire &>(Fans::print(PhysicalToolIndex::from_raw(0))).safeState();
    static_cast<CFanCtl3Wire &>(Fans::heat_break(PhysicalToolIndex::from_raw(0))).safeState();
